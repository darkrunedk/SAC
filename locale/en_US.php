...
$lang = array(
	...
	"STEAM_GAME_ID" => "Write the AppID or custom URL (the games id or custom url)...",
	"CHECK" => "Check",
	...
	"WHAT_IS_APP_ID" => "What is an AppID?",
	"WHAT_IS_APP_ID_ANSWER" => "An AppID is an ID, that a game (or program, software etc) gets on Steam, so you are able to find that specific item (in the store etc). You can often find the AppID in the addressbar. It could look like this:<br/>http://store.steampowered.com/app/475150/<br/>The AppID is the part following http://store.steampowered.com/app/, which in this case is 475150. An AppID is always a number (without decimals)"
);
